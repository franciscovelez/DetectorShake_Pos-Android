...
public class DetectorShakePos extends Activity implements SensorEventListener{
	...
	public void onSensorChanged(SensorEvent event) {		
		synchronized (this) {
			...
			if(curX<-umbral_pos) textPantalla.setText("Posición: Horizontal");
			if(curX> umbral_pos) textPantalla.setText("Posición: Horizontal inverso");
			if(curY<-umbral_pos) textPantalla.setText("Posición: Vertical inverso");
			if(curY> umbral_pos) textPantalla.setText("Posición: Vertical");
